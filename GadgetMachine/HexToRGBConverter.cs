        ...
        public override RGB Convert()
        {
            ...
            foreach (string num in value)
            {
                ...
                foreach (char digit in num)
                {
                    ...
                    if (i == 0)
                        result.AddRed(hexValue * Math.Pow(numberSystemPower, --degree));
                    else if (i == 1)
                        result.AddGreen(hexValue * Math.Pow(numberSystemPower, --degree));
                    else
                        result.AddBlue(hexValue * Math.Pow(numberSystemPower, --degree));
                }
                ++i;
            }
